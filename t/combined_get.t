...
$h->push_header("Accept-Encoding" => 'gzip,deflate');
...
if ($res->is_success) {
    is($res->header("Content-Encoding"), "deflate", "The Content-Encoding should return deflate");
...
$h->push_header("Accept-Encoding" => 'deflate,gzip');
